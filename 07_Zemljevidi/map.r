...
SIob$Povrsinakm2 <- SIob$OB_POV / 1e6
...
findInterval(SIob$Povrsinakm2,brks,all.inside=TRUE)
...
# # To ne deluje, če nimaš registriranega Google Maps API key.
...
# # Geokodiranje naslovov preko Google Maps API
# # to ne deluje, če nimaš registriranega API KEY
