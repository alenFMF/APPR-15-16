...
## Metaznaki in posebni znaki {.smaller}
...
```r
> grep("^[a-zA-ZčšžČŠŽ][a-zčšž][a-zčšž]$", c("Čas", "teče", "nič", "ne", 
"reče:", "tik", "tak"))
[1] 1 3 6 7
```
...
## Pridobivanje podvzorcev {.smaller}
...
## Pridobivanje tabel iz razdelitev {.smaller}
